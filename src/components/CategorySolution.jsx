      ...
      <div className="p-10 bg-white rounded-4xl shadow-black cursor-default drop-shadow-[0px_0px_0_rgba(79,70,229,1)] hover:-translate-y-4 hover:drop-shadow-[0px_10px_0_rgba(79,70,229,1)] ease-linear duration-75">
        <div className="flex">
          <svg
            ...
            fill="currentColor"
            className="bi bi-shop text-indigo-600 mr-4 my-auto md:w-10 w-7 h-auto"
            viewBox="0 0 16 16"
          >
            <path
              fillRule="evenodd"
          ...
          <h3 className="text-indigo-600 md:text-3xl text-xl font-bold">
            Soluciones E-commerce
          </h3>
        </div>
        <div className="md:flex block mt-6">
          <img
            className="w-full object-cover object-center rounded-4xl drop-shadow-xl h-52 mr-4 mb-4"
            src="./src/assets/person-adding-clothes-to-cart-closeup-for-online-shopping-campaign.jpg"
            alt=""
          />
          <p className="text-indigo-600 md:text-xl text-lg font-normal">
