...
import SimpleSocialIcon from "./SimpleSocialIcon";
    ...
    <div className="grid grid-cols-1 my-10">
      ...
      <a className="cursor-pointer" href="#quiensoy">
        <svg
          ...
          height="36"
          fill="currentColor"
          className="bi bi-chevron-down text-gray-light w-auto fixed bottom-10 right-1/2 hover:animate-none animate-bounce"
          viewBox="0 0 16 16"
        >
          <path
            fillRule="evenodd"
